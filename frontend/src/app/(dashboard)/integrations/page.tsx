...
export default function IntegrationsPage() {
  ...
  const [waText, setWaText] = useState("Salam {{leadName}}! Main RENS properties se baat kar raha hoon. Palm Jumeirah property details download karne ke liye is link pe click karein.");
  const [waMediaUrl, setWaMediaUrl] = useState("https://rensecosystem.com/brochures/palm_jumeirah_villa.pdf");
  ...
  const [smsText, setSmsText] = useState("RENS Alert: Dear {{leadName}}, a meeting has been scheduled with your Agent. Please verify your OTP code: 8291.");
  ...
  const [portalLeadData, setPortalLeadData] = useState({
    name: "Aizaz Ahmed",
    email: "aizaz@rensecosystem.com",
    phone: "+971501234567",
    propertyRef: "RENS-PROP-101",
                  ...
                  <div className="space-y-5">
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="space-y-2">
                        ...
                        <input 
                          type="text" 
                          placeholder="Welcome to RENS Ecosystem CRM" 
                    ...
                    <div className="w-[320px] h-[550px] bg-slate-950 border-[10px] border-slate-800 rounded-[40px] shadow-2xl relative overflow-hidden flex flex-col justify-between">
                      ...
                      <div className="bg-secondary/90 border-b border-white/5 pt-8 pb-3.5 px-4 flex justify-between items-center text-xs flex-shrink-0 z-10">
                        <div className="flex items-center gap-2">
                          ...
                          <div>
                            <p className="font-extrabold text-white text-[10px]">RENS Business AI</p>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 animate-fade-in text-left">
                  ...
                  <div className="glass p-6 rounded-2xl border border-white/5 bg-slate-900/40 space-y-6">
                    <div className="space-y-1">
                      ...
                      <p className="text-xs text-muted-foreground leading-relaxed">Geocode listing addresses dynamically, resolving locations to precise latitudes and longitudes. This coordinates mapping systems inside RENS listing pages.</p>
                    </div>
            ...
            <form onSubmit={handleSaveTemplate} className="space-y-4 text-xs text-left">
              ...
              <div className="space-y-1.5">
                ...
                <textarea 
                  rows={5}
                  required
                  placeholder="Salam {{leadName}}! Welcome aboard to RENS ERP..."
