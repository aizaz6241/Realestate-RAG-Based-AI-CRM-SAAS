...
async function main() {
  ...
  const usersData = [
    { email: "admin@rens.com", firstName: "Admin", lastName: "User", role: Role.SUPER_ADMIN },
    { email: "aizazkhan6241@gmail.com", firstName: "Muhammad Aizaz", lastName: "Khan", role: Role.HR },
    { email: "agent1@rens.com", firstName: "John", lastName: "Agent", role: Role.AGENT },
    { email: "agent2@rens.com", firstName: "Sarah", lastName: "Agent", role: Role.AGENT },
    { email: "manager@rens.com", firstName: "Robert", lastName: "Manager", role: Role.SALES_MANAGER },
    { email: "sijad@gmail.com", firstName: "Sijad", lastName: "Ullah", role: Role.LOGISTICS },
    { email: "finance@rens.com", firstName: "Faisal", lastName: "Finance", role: Role.FINANCE }
  ];
  ...
  const profilesData = [
    { email: "admin@rens.com", department: "Administration", designation: "Executive Director", salary: 35000 },
    { email: "aizazkhan6241@gmail.com", department: "Human Resources", designation: "HR Manager", salary: 15000 },
    { email: "agent1@rens.com", department: "Sales", designation: "Senior Property Consultant", salary: 12000 },
    { email: "agent2@rens.com", department: "Sales", designation: "Junior Property Consultant", salary: 10000 },
    { email: "manager@rens.com", department: "Sales", designation: "Sales Director", salary: 22000 },
    { email: "sijad@gmail.com", department: "Logistics", designation: "Logistics Lead & Driver", salary: 8500 },
    { email: "finance@rens.com", department: "Finance", designation: "Finance Controller", salary: 16000 }
  ];
  ...
  const owners = [
    await prisma.owner.create({
      data: {
        ...
        commissionRate: 2.0,
        organizationId: org.id,
        assignedToId: users["agent1@rens.com"].id
      }
    }),
    await prisma.owner.create({
      data: {
        ...
        commissionRate: 2.5,
        organizationId: org.id,
        assignedToId: users["agent2@rens.com"].id
      }
    }),
    await prisma.owner.create({
      data: {
        ...
        commissionRate: 5.0,
        organizationId: org.id,
        assignedToId: users["manager@rens.com"].id
      }
    })
  ];
  ...
  await prisma.ownerDocument.create({
    data: { name: "Emirates ID Card - Fahad", fileUrl: "https://rens-erp.s3.amazonaws.com/docs/eid_fahad.pdf", ownerId: owners[0].id }
  });
  await prisma.ownerDocument.create({
    data: { name: "Title Deed - Palm Villa 14", fileUrl: "https://rens-erp.s3.amazonaws.com/docs/title_deed_palm.pdf", ownerId: owners[0].id }
  });
  ...
  const docs = [
    await prisma.document.create({
      data: {
        ...
        category: "SALES",
        fileUrl: "https://rens-erp.s3.amazonaws.com/docs/exclusivity_palm.pdf",
        accessRole: "AGENT",
        tags: ["exclusivity", "agreement", "palm jumeirah"],
        createdById: users["admin@rens.com"].id,
        organizationId: org.id
      }
    }),
    await prisma.document.create({
      data: {
        name: "RENS Corporate Employee Handbook 2026",
        category: "CORPORATE",
        fileUrl: "https://rens-erp.s3.amazonaws.com/docs/handbook.pdf",
        accessRole: "VIEWER",
    ...
    await prisma.document.create({
      data: {
        ...
        category: "KYC",
        fileUrl: "https://rens-erp.s3.amazonaws.com/docs/title_deed_burj.pdf",
        accessRole: "ADMIN",
  ...
  await prisma.employeeDocument.create({
    data: {
      ...
      category: "ID",
      fileUrl: "https://rens-erp.s3.amazonaws.com/docs/eid_aizaz.pdf",
  ...
  await prisma.employeeDocument.create({
    data: {
      ...
      category: "CONTRACT",
      fileUrl: "https://rens-erp.s3.amazonaws.com/docs/contract_john.pdf",
      employeeProfileId: profiles["agent1@rens.com"].id
    }
  });
  ...
  await prisma.leaveRequest.create({
    data: {
      ...
      employeeProfileId: profiles["agent2@rens.com"].id
    }
  });
  await prisma.leaveRequest.create({
    data: {
  ...
  await prisma.activityLog.create({
    data: { description: "Conducted sales negotiation meeting at Dubai Marina office.", category: "MEETING", duration: 90, employeeProfileId: profiles["agent1@rens.com"].id }
  });
  await prisma.activityLog.create({
    data: { description: "Wrote property listing brochures for Palm Jumeirah signature villa.", category: "WORK", duration: 180, employeeProfileId: profiles["agent1@rens.com"].id }
  });
  ...
  await prisma.performanceReview.create({
    data: {
      ...
      reviewedById: users["admin@rens.com"].id,
      employeeProfileId: profiles["agent1@rens.com"].id
    }
  });
  await prisma.performanceReview.create({
  ...
  await prisma.communicationTemplate.create({
    data: {
      ...
      content: "Your RENS Ecosystem secure verification code is: 582914. Valid for 5 minutes.",
      channel: "SMS",
      organizationId: org.id
    }
  });
